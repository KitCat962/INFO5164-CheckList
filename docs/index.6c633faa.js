function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}var t=globalThis,r={},n={},i=t.parcelRequire94c2;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},t.parcelRequire94c2=i);var s=i.register;s("47Mwn",function(t,r){e(t.exports,"db",()=>l),e(t.exports,"auth",()=>u),i("fhN3L");var n=i("7xvHX");i("ilpIi");var s=i("9HrqM");i("6AR8M");var o=i("4V2Lt");let a=(0,n.initializeApp)({apiKey:"AIzaSyCLWcM4xIapAEgIbpK_93JSXK139XRErt4",authDomain:"info-5146-todo.firebaseapp.com",projectId:"info-5146-todo",storageBucket:"info-5146-todo.firebasestorage.app",messagingSenderId:"438512065808",appId:"1:438512065808:web:15f274f08b066c9ef4d995"}),l=(0,s.getFirestore)(a),u=(0,o.o)()}),s("fhN3L",function(t,r){e(t.exports,"initializeApp",()=>i("7xvHX").initializeApp),e(t.exports,"registerVersion",()=>i("7xvHX").registerVersion),/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r9{constructor(e){this.Eo=e.Eo,this.Ao=e.Ao}Ro(e){this.Vo=e}mo(e){this.fo=e}po(e){this.yo=e}onMessage(e){this.wo=e}close(){this.Ao()}send(e){this.Eo(e)}So(){this.Vo()}bo(){this.fo()}Do(e){this.yo(e)}vo(e){this.wo(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let r7="WebChannelConnection";class ne extends class{get Co(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;let t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),n=encodeURIComponent(this.databaseId.database);this.Fo=t+"://"+e.host,this.Mo=`projects/${r}/databases/${n}`,this.xo="(default)"===this.databaseId.database?`project_id=${r}`:`project_id=${r}&database_id=${n}`}Oo(e,t,r,n,i){let s=r8(),o=this.No(e,t.toUriEncodedString());_("RestConnection",`Sending RPC '${e}' ${s}:`,o,r);let a={"google-cloud-resource-prefix":this.Mo,"x-goog-request-params":this.xo};return this.Bo(a,n,i),this.Lo(e,o,a,r).then(t=>(_("RestConnection",`Received RPC '${e}' ${s}: `,t),t),t=>{throw b("RestConnection",`RPC '${e}' ${s} failed with error: `,t,"url: ",o,"request:",r),t})}ko(e,t,r,n,i,s){return this.Oo(e,t,r,n,i)}Bo(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+y}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,r)=>e[r]=t),r&&r.headers.forEach((t,r)=>e[r]=t)}No(e,t){let r=r4[e];return`${this.Fo}/v1/${t}:${r}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Lo(e,t,r,n){let i=r8();return new Promise((s,o)=>{let a=new d.XhrIo;a.setWithCredentials(!0),a.listenOnce(d.EventType.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case d.ErrorCode.NO_ERROR:let t=a.getResponseJson();_(r7,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case d.ErrorCode.TIMEOUT:_(r7,`RPC '${e}' ${i} timed out`),o(new C(S.DEADLINE_EXCEEDED,"Request time out"));break;case d.ErrorCode.HTTP_ERROR:let r=a.getStatus();if(_(r7,`RPC '${e}' ${i} failed with status:`,r,"response text:",a.getResponseText()),r>0){let e=a.getResponseJson();Array.isArray(e)&&(e=e[0]);let t=null==e?void 0:e.error;if(t&&t.status&&t.message){let e=function(e){let t=e.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(t)>=0?t:S.UNKNOWN}(t.status);o(new C(e,t.message))}else o(new C(S.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new C(S.UNAVAILABLE,"Connection failed."));break;default:T()}}finally{_(r7,`RPC '${e}' ${i} completed.`)}});let l=JSON.stringify(n);_(r7,`RPC '${e}' ${i} sending request:`,n),a.send(t,"POST",l,r,15)})}qo(e,t,r){let i=r8(),s=[this.Fo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=(0,d.createWebChannelTransport)(),a=(0,d.getStatEventTarget)(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;void 0!==u&&(l.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(l.useFetchStreams=!0),this.Bo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;let h=s.join("");_(r7,`Creating RPC '${e}' stream ${i}: ${h}`,l);let c=o.createWebChannel(h,l),f=!1,p=!1,g=new r9({Eo:t=>{p?_(r7,`Not sending because RPC '${e}' stream ${i} is closed:`,t):(f||(_(r7,`Opening RPC '${e}' stream ${i} transport.`),c.open(),f=!0),_(r7,`RPC '${e}' stream ${i} sending:`,t),c.send(t))},Ao:()=>c.close()}),m=(e,t,r)=>{e.listen(t,e=>{try{r(e)}catch(e){setTimeout(()=>{throw e},0)}})};return m(c,d.WebChannel.EventType.OPEN,()=>{p||(_(r7,`RPC '${e}' stream ${i} transport opened.`),g.So())}),m(c,d.WebChannel.EventType.CLOSE,()=>{p||(p=!0,_(r7,`RPC '${e}' stream ${i} transport closed`),g.Do())}),m(c,d.WebChannel.EventType.ERROR,t=>{p||(p=!0,b(r7,`RPC '${e}' stream ${i} transport errored:`,t),g.Do(new C(S.UNAVAILABLE,"The operation could not be completed")))}),m(c,d.WebChannel.EventType.MESSAGE,t=>{var r;if(!p){let s=t.data[0];s||T();let o=(null==s?void 0:s.error)||(null===(r=s[0])||void 0===r?void 0:r.error);if(o){_(r7,`RPC '${e}' stream ${i} received error:`,o);let t=o.status,r=function(e){let t=n[e];if(void 0!==t)return tW(t)}(t),s=o.message;void 0===r&&(r=S.INTERNAL,s="Unknown error status: "+t+" with message "+o.message),p=!0,g.Do(new C(r,s)),c.close()}else _(r7,`RPC '${e}' stream ${i} received:`,s),g.vo(s)}}),m(a,d.Event.STAT_EVENT,t=>{t.stat===d.Stat.PROXY?_(r7,`RPC '${e}' stream ${i} detected buffering proxy`):t.stat===d.Stat.NOPROXY&&_(r7,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{g.bo()},0),g}}function nt(){return"undefined"!=typeof document?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e7(e,t,r=!1){if((0,s._isFirebaseServerApp)(e.app))return Promise.reject(y(e));let n="signIn",i=await e8(e,n,t),o=await e6._fromIdTokenResponse(e,n,i);return r||await e._updateCurrentUser(o.user),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tA extends eL{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return ej(e,this._buildIdpRequest())}_linkToIdToken(e,t){return ej(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return ej(e,this._buildIdpRequest())}_buildIdpRequest(e){let t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function tk(e){return e7(e.auth,new tA(e),e.bypassAuthState)}function tx(e){let{auth:t,user:r}=e;return w(r,t,"internal-error"),e9(r,new tA(e),e.bypassAuthState)}async function tR(e){let{auth:t,user:r}=e;return w(r,t,"internal-error"),e4(r,new tA(e),e.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=index.6c633faa.js.map
